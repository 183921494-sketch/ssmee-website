      ...
      <div class="detail-grid">
        ...
        <div class="detail-info">
          ...
          <div class="attrs">
            ...
            <div class="attr"><span class="key">MOQ</span><span class="val">500 {{ t('detail.bundles') }}</span></div>
      ...
      <div class="spec-table">
        ...
        <table>
          <tbody>
            ...
            <tr><td>MOQ</td><td>500{{ t('detail.bundles') }}{{ t('detail.up') }}</td></tr>
